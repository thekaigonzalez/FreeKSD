-- FreeKSD's version of Lua argparse used in luarocks.

local SendFlag = require('freeKSD.helpers.SendFlag') -- import flags
--[[
    TODO: replace all os.exit() with SendFlag to instead return process exit code so it wont exit the entire FreeKSD system.
]]
